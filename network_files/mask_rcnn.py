...
class MaskRCNN(FasterRCNN):
    ...
    def forward(self, images, targets=None, stat_features=None):
        # ... 现有的处理代码 ...
        ...
        # 在这里添加使用 stat_features 的逻辑
        # ...

        # 调用 RoIHeads
        if self.roi_heads:
            _, result, detector_losses = self.roi_heads(features, proposals, images.image_sizes, targets, stat_features)
        else:
            x = features
            result = proposals
            detector_losses = {}
